...
% Using a subfiles latex document header information like this should be contained in the main.tex file. I leave this here in case one copies this back to Overleaf or similar editor.
%\usepackage{graphicx}
%\graphicspath{ {/bike-regressor/report/images/} }
